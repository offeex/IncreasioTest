	...
	<div class="m-[28px] w-full">
		...
		<div class="mt-6">
			...
			<div class="mt-4 flex flex-row gap-5 w-full">
				<Category iconPath="fire.svg" name={cats[0].name} />
				<Category iconPath="apple.svg" name={cats[1].name} />
				<Category iconPath="money.svg" name={cats[2].name} />
			</div>
		</div>

		<div class="flex flex-row mt-16 gap-8 max-w-full">
			<!-- Analytics -->
			<div class="w-full">
				<!-- Analystics header -->
				<div class="prikol">
				...
				<!-- Chart itself -->
				<div class="mt-2 min-w-[800px] w-full h-[575px] bg-[#1D1D41] rounded-3xl">
					<Chart />
				</div>
			</div>
